                                ...
                                <div class="box-header">
                                    <div style="padding:10px;">
                                        ...
                                        ?>
                                                ...
                                                <button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#addModal"><i class="fa fa-user-plus" aria-hidden="true"></i> Add Services</button>  
                                        ...
                                        <table id="table" class="table table-bordered table-striped">
                                            ...
                                            <tbody>
                                                ...
                                                {   
                                                    ...
                                                    $squery = mysqli_query($con, "select * from tblservices");
                                        ...
                                        <table id="table" class="table table-bordered table-striped">
                                            ...
                                            <tbody>
                                                ...
                                                {   
                                                    ...
                                                    $squery = mysqli_query($con, "select * from tblservices2");
                                                    while($row = mysqli_fetch_array($squery))
                                                    {
                                                        echo '
                                                        <tr>
