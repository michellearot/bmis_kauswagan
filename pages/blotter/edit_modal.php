                ...
                <div class="col-sm-4">
                  <select name="txt_edit_pname" class="form-control input-sm select2" style="width:100%">
                    ...
                    while($rowcp = mysqli_fetch_array($qcp)){
                      echo '<option value="'.$rowcp['id'].'">'.$rowcp['lname'].', '.$rowcp['fname'].' '.$rowcp['mname'].'</option>';
                    }
                    echo '
                  </select>
                </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-4">
                  <select name="ddl_acttaken" class="form-control input-sm">
                    <option value="1st Option">Conduct Initial Investigation (1st Option)</option>
                    <option value="2nd Option">Schedule a Mediation Hearing (2nd Option)</option>
                  </select>
                </div>
              </div><br>
              <div class="form-group">
